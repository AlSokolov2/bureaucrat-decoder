...
3. Срок (до какой даты нужно оплатить/явиться/предоставить)
4. Что делать (конкретное действие: оплатить, явиться, предоставить, проигнорировать)

Правила для поля "Срок":
- Если указана конкретная дата — используй её.
- Если указан только расчётный период (например "июнь 2026 г.") — крайний срок обычно 10 число следующего месяца. Напиши: "до 10.07.2026 (расчётный период: июнь 2026)".
- Если дат несколько — укажи самую раннюю.
- Если дат нет совсем — "не указан".

Общие правила:
- ТОЛЬКО факты из текста. Ничего не додумывай кроме срока (см. выше).
- Если не уверен в чём-то кроме срока — напиши "не могу определить, уточните в ведомстве".
